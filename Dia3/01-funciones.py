...
#  que se puede reutilizar cuantas veces 
# sea necesario
...
# al poner la f antes de un texto significa que lo
# que vaya dentro de las llaves sera codigo 
# python, codigo q puede suma etc...
print(f"Hola {nombre} buenas tardes")

saludarConNombre("Eduardo")

# para definir parametros opcionales se tiene que indicar 
# cual sera su valor en el caso que al llamar a 
# la funcion no se provea dicho parametro
...
# en python no se puede volver a declarar 
# la misma funcion, ya que, como las variables, estas 
# se sobreescribiran y perdera su definicion anterior

# si nosotros queremos recibir parametros obligatoriamente 
# y algunos opcionalmente, los parametros opcionales
# SIEMPRE tienen que ir al final de la declaracion

def registro(correo, nombre=None): 
# Los dos punto reemplaza  {}
    print("Registro exitoso")

registro("ederiveroman@gmail.com")

# funcion que recibe dos numeros y si la sumatoria 
# de ambos es par indicar su mitad y si es impar, 
...
indeterminada(nombre="Eduardo",apellidos="de RIVERO",nacionalidad="Peruano")
